...
assert.match(buildInfo, /displayVersion:\s*"0\.17\.0 TEST\.1"/);
assert.match(buildInfo, /buildVersion:\s*"0\.17\.0-test\.1"/);
...
console.log('v0.17.0 TEST.1 release polish uses the canonical build contract');
