...
assert.equal(read("VERSION").trim(), "0.17.1-test.1", "VERSION identifies TEST.1");
assert.match(index, /Koryto 0\.17\.1 TEST\.1/, "HTML contains the visible build identity");
...
assert.match(buildInfo, /buildVersion:\s*"0\.17\.1-test\.1"/, "build-info is current");
...
console.log("v0.17.1 TEST.1 visual foundation contract passed");
