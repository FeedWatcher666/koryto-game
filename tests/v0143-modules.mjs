...
const index=readText('index.html');assert.match(index,/src\/core-data\.js/);assert.match(index,/src\/v0146-playtest\.js/);assert.match(index,/src\/v0148-visual-system\.js/);assert.match(index,/src\/v0149-pixel-assets\.js/);assert.match(index,/src\/v0152-reference-match\.js/);assert.match(index,/0\.15\.2 TEST\.1/);assert.equal(readText('VERSION').trim(),'0.15.2-test.1');
const workflow=readText('.github/workflows/v0142-stability.yml');assert.match(workflow,/Koryto v0\.15\.2 TEST\.1/);assert.match(workflow,/test\/v0\.15\.2-reference-match/);assert.match(workflow,/koryto-v0\.15\.2-test\.1/);
console.log('v0.14.3 save contract remains stable inside layered v0.15.2 TEST.1');
