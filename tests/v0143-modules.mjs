...
const index=readText('index.html');assert.match(index,/src\/core-data\.js/);assert.match(index,/src\/v0146-playtest\.js/);assert.match(index,/src\/v0148-visual-system\.js/);assert.match(index,/0\.14\.8 TEST\.10/);assert.equal(readText('VERSION').trim(),'0.14.8-test.10');
const workflow=readText('.github/workflows/v0142-stability.yml');assert.match(workflow,/Koryto v0\.14\.8 TEST\.10/);assert.match(workflow,/test\/v0\.14\.8-test10-clean/);assert.match(workflow,/koryto-v0\.14\.8-test\.10/);
console.log('v0.14.3 save contract remains stable inside v0.14.8 TEST.10');
