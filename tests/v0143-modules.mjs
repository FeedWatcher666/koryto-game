...
const workflow=readText('.github/workflows/v0142-stability.yml');assert.match(workflow,/Koryto v0\.14\.8 TEST\.10/);assert.match(workflow,/test\/v0\.14\.8-test10/);assert.match(workflow,/koryto-v0\.14\.8-test\.10/);
