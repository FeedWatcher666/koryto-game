...
const workflow=readText('.github/workflows/v0142-stability.yml');assert.match(workflow,/Koryto v0\.14\.7 TEST\.10/);assert.match(workflow,/test\/v0\.14\.6-test10/);assert.match(workflow,/koryto-v0\.14\.7-test\.10/);
