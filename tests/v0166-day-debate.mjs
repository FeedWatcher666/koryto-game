...
assert.match(browserPolish, /Dolní Vejprnice 0\.16\.8 TEST\.1/);

console.log('v0.16.6 day summary, debate and browser-smoke polish contract passed inside v0.16.8');
