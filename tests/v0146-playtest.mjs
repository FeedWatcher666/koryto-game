...
assert.match(index, /0\.14\.8 TEST\.10/);
...
assert.equal(readText('VERSION').trim(), '0.14.8-test.10');
...
console.log(`v0.14.6 AI playtest lab ok inside v0.14.8: ${lab.report.routeDiversity} routes, ${lab.report.eventCoverage.rate}% events`);
