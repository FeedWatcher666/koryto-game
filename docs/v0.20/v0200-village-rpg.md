# v0.20.0 — Village RPG Reboot

## Rozhodnutí

v0.18 a v0.19 jsou uzavřené experimenty. První byl rozvětvený formulář, druhý abstraktní karetní systém. Ani jeden nevytvořil důvod mít rád Dolní Vejprnice, jejich postavy nebo svět.

Reboot se proto vrací k původnímu příslibu: malá česká obec jako satirický RPG svět, ve kterém se hráč fyzicky pohybuje, potkává absurdní obyvatele, sbírá podezřelé předměty a sleduje soupeře přímo na mapě.
...
7. Mezi dny přichází absurdní obecní událost.
8. Kampaň končí novinovou titulní stranou.
...
- každá další iterace v0.20.1 až v0.20.9 musí zlepšovat zábavu, nikoli jen přidávat obsah.
...
- konec působí jako odměna nebo komická prohra,
- hráč má po dokončení chuť zkusit jinou trasu nebo kandidáta.
